...
class QvSuggeriments(QDialog):
    def __init__(self, acceptAction=QWidget.close, parent=None):
        ...
        self.lblCapcalera.setStyleSheet('background-color: %s' %QvConstants.COLORFOSC)
    ...
    def formata(self): 
        ...
        #self.lblCapcalera.setStyleSheet('QLabel{color: %s; background-color: solid %s; border: 0px;}'%(QvConstants.COLORFOSC,QvConstants.COLORBLANC))
        ...
        self.widgetSup.setStyleSheet('color: %s; background-color: solid %s; border: 0px;'%(QvConstants.COLORFOSC,QvConstants.COLORBLANC))
