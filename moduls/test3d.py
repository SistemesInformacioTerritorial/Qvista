...
class QvBrowser(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.browser.settings().setAttribute(QWebSettings.JavascriptEnabled, True)
        self.browser.setUrl(QUrl('https://www.google.com/maps/place/Casa+Llotja+de+Mar/@41.3820247,2.1844697,173a,35y,270h,39.48t/data=!3m1!1e3!4m5!3m4!1s0x12a4a2ffbbb0e647:0xfc96ad9166872174!8m2!3d41.3822927!4d2.1825568'))
...
class QvStreetView(QWidget):
    ...
    def llevame_old(self,xx,yy):
        ...
        try:
            ...
            qbrowser.browser.setUrl(QUrl('https://www.google.com/maps/place/Casa+Llotja+de+Mar/@41.3820247,2.1844697,173a,35y,270h,39.48t/data=!3m1!1e3!4m5!3m4!1s0x12a4a2ffbbb0e647:0xfc96ad9166872174!8m2!3d41.3822927!4d2.1825568'))
