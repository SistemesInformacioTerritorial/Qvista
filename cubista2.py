...
"color: #FFFFFF")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../dades/imatges/arrow-left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../dades/imatges/arrow-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
