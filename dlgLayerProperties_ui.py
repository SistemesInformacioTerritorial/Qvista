...
# Form implementation generated from reading ui file 'dlgLayerProperties_ui.ui'
#
...
class Ui_LayerProperties(object):
    def setupUi(self, LayerProperties):
        ...
        LayerProperties.resize(313, 273)
    ...
    def retranslateUi(self, LayerProperties):
        ...
        LayerProperties.setWindowTitle(_translate("LayerProperties", "Propietats del nivell"))
        self.label.setText(_translate("LayerProperties", "Nom del nivell"))
        self.chkScale.setText(_translate("LayerProperties", "Visible segons escala:"))
